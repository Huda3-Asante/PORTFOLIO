    ...
    <header class="logo-env">
        ...
        <div class="logo" style="">
            <a href="<?php echo base_url(); ?>">
                <img src="uploads/logo.jpg" style="max-height:80px;" />
            </a>
        </div>
    ...
    <ul id="main-menu" class="">
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Student Management'); ?></span>
            </a>
            <ul>
                ...
                <li class="<?php if ($page_name == 'student_information')
                    ...
                    <ul>
                        ...
                        foreach ($classes as $row):
                            ?>
                            <li
                                class="<?php if ($page_name == 'student_information' && $class_id == $row['class_id'])
                                    echo 'active'; ?>">
                                <a
                ...
                <li class="<?php if ($page_name == 'student_marksheet')
                    ...
                    <ul>
                        ...
                        foreach ($classes as $row):
                            ?>
                            <li
                                class="<?php if ($page_name == 'student_marksheet' && $class_id == $row['class_id'])
                                    echo 'active'; ?>">
                                <a
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Academics Management'); ?></span>
            </a>
            <ul>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Fees Management'); ?></span>
            </a>
            <ul>
                <!-- PAYMENT -->
                <li class="<?php if ($page_name == 'invoice')
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Administrative Tools & Accounting'); ?></span>
            </a>
            <ul>
                <!-- PARENTS -->
                <li class="<?php if ($page_name == 'parent')
                    ...
                    <a href="<?php echo base_url(); ?>index.php?admin/parent">
                        ...
                        <span><?php echo ('Parents Database'); ?></span>
                    </a>
                </li>
                <!-- TEACHER -->
                <li class="<?php if ($page_name == 'teacher')
                    ...
                    <a href="<?php echo base_url(); ?>index.php?admin/teacher">
                        ...
                        <span><?php echo ('Teachers Database'); ?></span>
                    </a>
                </li>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Lessons Management'); ?></span>
            </a>
            <ul>
                <!-- LIBRARY -->
                ...
                <li class="<?php if ($page_name == 'study_material')
                    ...
                    <a href="<?php echo base_url(); ?>index.php?admin/study_material">
                        <i class="entypo-dot"></i>
                        <span><?php echo ('Lesson notes'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Communications'); ?></span>
            </a>
            <ul>
                <!-- NOTICEBOARD -->
